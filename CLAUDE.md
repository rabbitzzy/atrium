...
### Session
A discrete kiosk visit. Has: student ID, timestamp, list of tasks attempted, transcripts of keyboard chat (voice chat deferred to Phase 3), scans of submitted work, AI evaluations, and the resulting state delta on the skill tree.
